...
\begin{table*}[t]
    \centering
    \caption{Specific Heat Capacity Results. ($c_{meas}$: measured, $c_{ref}$: reference).}
    \label{tab:results}
    \pgfplotstabletypeset[
...
\vspace{0.5em}
\noindent
\url{https://github.com/ibeuler/LAB-Reports/tree/main/THERMODYNAMICS_AND_STATISTICAL_PHYSICS/2nd_Heat_Capacity_of_Metals}

\vspace{1em}
\begin{center}
    \qrcode[height=1in]{https://github.com/ibeuler/LAB-Reports/}
\end{center}
